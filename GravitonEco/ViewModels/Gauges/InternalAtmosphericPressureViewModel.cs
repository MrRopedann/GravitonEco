...
{
    public partial class InternalAtmosphericPressureViewModel : BaseModbusViewModel
    {
        public InternalAtmosphericPressureViewModel(ModbusTcpClient modbusTcp, string name)
        : base(modbusTcp, name) { }
